...
/// See also [interestCategoryRepository].
@ProviderFor(interestCategoryRepository)
final interestCategoryRepositoryProvider =
    AutoDisposeProvider<InterestCategoryRepository>.internal(
  interestCategoryRepository,
  name: r'interestCategoryRepositoryProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$interestCategoryRepositoryHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
